...
/* Function Declaration -- [3] Section A.3 */
...
/* Padding Declaration -- [3] Section A.3 */
...
Reference [3] Section A.3 md5.c
*/
static void Encode(output, input, length) unsigned char *output;
UINT4 *input;
unsigned int length;
{
    unsigned int i, j;
...
static void MD5_memcpy(output, input, length)
    POINTER output;
POINTER input;
unsigned int length;
{
...
static void MD5_memset(output, value, length)
    POINTER output;
int value;
unsigned int length;
{
